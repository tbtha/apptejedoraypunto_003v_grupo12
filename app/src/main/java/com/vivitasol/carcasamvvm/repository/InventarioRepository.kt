...
class InventarioRepository(
    ...
    suspend fun crearProducto(producto: Producto): Result<Producto> {
        return try {
            val nuevoProducto = inventarioService.crearProducto(producto)
            refreshProductos()
    ...
    suspend fun actualizarProducto(id: Int, producto: Producto): Result<Producto> {
        return try {
            val productoActualizado = inventarioService.actualizarProducto(id, producto)
            refreshProductos()
